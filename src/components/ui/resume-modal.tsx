      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-2 sm:p-4 md:p-6 overflow-hidden">
          ...
          <motion.div
            ...
            } bg-[#09090c] border border-white/10 rounded-2xl sm:rounded-3xl shadow-[0_25px_70px_rgba(0,0,0,0.9)] flex flex-col overflow-hidden z-10 transition-all duration-300`}
            role="dialog"
            aria-modal="true"
            aria-label={title}
          >
            {/* Window Header */}
            <div className="flex items-center justify-between px-4 sm:px-6 py-3.5 border-b border-white/10 bg-[#0c0c10]/95 backdrop-blur-2xl shrink-0 select-none">
                ...
                <div className="flex items-center gap-2.5 overflow-hidden">
                  ...
                  <div className="overflow-hidden">
                    ...
                    <p className="text-[11px] font-mono text-zinc-400 truncate">
                      Asarudeen S • Full Stack Developer
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/[0.04] hover:bg-white/[0.08] text-zinc-200 hover:text-white border border-white/10 text-xs font-semibold tracking-wide transition-all active:scale-95"
                ...
                <button
                  onClick={() => setIsFullscreen(!isFullscreen)}
                  className="hidden sm:inline-flex p-2 rounded-xl bg-white/[0.04] hover:bg-white/[0.08] text-zinc-400 hover:text-white border border-white/10 transition-colors active:scale-95 cursor-pointer"
                ...
                <button
                  onClick={onClose}
                  className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl bg-white/[0.06] hover:bg-red-500/20 text-zinc-300 hover:text-red-300 border border-white/10 hover:border-red-500/30 transition-all active:scale-95 cursor-pointer"
